  ...
  <div id="page-wrapper"><div id="page">
    ...
    <div id="header"><div class="section clearfix">
      ...
      <?php endif; ?>
		...
		<?php 
			$img = '<img src="'. $base_path . $directory . '/images/en-espanol.png" />';
			global $language;
			if ($language->language == 'en')
				$path = 'es/'.drupal_get_path_alias($_GET['q']);
			elseif($language->language == 'es')
				$path = drupal_get_path_alias($_GET['q'], 'es');
			
			echo l($img, $path, array('html' => array('html' => 'true')));	
			?>
    ...
    <div id="main-wrapper"><div id="main" class="clearfix<?php if ($primary_links || $navigation) { print ' with-navigation'; } ?>">
      ...
      <div id="content" class="column"><div class="section">
        ...
        <div id="content-area">
          ...
          <?php print $content; ?>
			<div class="more-link"><a href="<?php  echo base_path(); ?>news">See more ...</a></div>
        </div>
	...
	<?php print $sidebar_second; ?>
		...
		<!-- <div id="social-block">
			<div id="stay-connected">
				...
				<p>Sign-up to receive weekly news and updates from NNIRR</p>
			...
			<div id="facebook">
				<h2>Facebook Feed</h2>
				<fb:activity site="http://www.nnirr.org/"></fb:activity>
			</div>

			<div id="youtube">
				<h2>Youtube Network</h2>
				<div class="flashunit">
				<object width="270" height="204"> 
						    <param name="movie" value="http://www.youtube.com/cp/vjVQa1PpcFPhFNjPIbDeluVWqueyGJ5X4vVVfuvHhBY="></param><embed src="http://www.youtube.com/cp/vjVQa1PpcFPhFNjPIbDeluVWqueyGJ5X4vVVfuvHhBY=" type="application/x-shockwave-flash" width="270" height="204"></embed> 
				 </object> 
				</div>
			</div>
